...
const CambiarPassword = () => {
  ...
  return (
    <div className='absolute right-0 top-0 mt-12 w-80 min-w-min bg-white rounded-lg shadow-lg py-4 px-5 z-10'>
      <h2 className=' text-lg font-medium text-gray-800 mb-4'>Cambiar Contraseña</h2>
      <form onSubmit={handleSubmit}>
        {/* Contraseña actual */}
        <div className='mb-3'>
          <label htmlFor='password-actual' className='block font-medium text-gray-700 mb-1'>
            Contraseña actual
          </label>
          <input
            id='password-actual'
            ...
            className='w-full px-3 py-1 border rounded-lg bg-gray-50 text-gray-800 caret-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500'
            required
          />
        </div>
        ...
        <div className='mb-3'>
          <label htmlFor='repetir-password' className='block font-medium text-gray-700 mb-1'>
            Repetir contraseña
          </label>
          <input
            id='repetir-password'
